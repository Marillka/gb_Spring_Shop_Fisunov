package ru.rayumov.market.core.configs;
...
import ru.rayumov.market.core.properties.CartServiceIntegrationProperties;
    ...
    public WebClient cartServiceWebClient() {
        TcpClient tcpClient = TcpClient
                ...
                .doOnConnected(connection -> {
                    connection.addHandler(new ReadTimeoutHandler(cartServiceIntegrationProperties.getReadTimeout(), TimeUnit.MILLISECONDS));
